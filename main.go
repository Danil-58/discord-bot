...
import (
	...
	"github.com/Danil-58/discord-bot/log"
...
func waitForUserResponse(s *discordgo.Session, channelID string) <-chan *discordgo.MessageCreate { // waitForUserResponse waits for a user response and returns the message channel.
...
func generateTrapWord() (string, string) { // generateTrapWord
